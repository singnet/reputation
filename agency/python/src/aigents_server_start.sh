...
# Run Aigents
java -cp ../../bin/mail.jar:../../bin/pdfbox-app-2.0.0-RC2.jar:../../bin/javax.json-1.0.2.jar:../../bin/Aigents.jar -Xms1000m -Xmx2000m net.webstructor.agent.Farm store path './al_test.txt', http port 1180, cookie domain localtest.com, console off &
sleep 5
