...
good_agent = {"range": [1,8], "values": [100,1000], "transactions": 100}
bad_agent = {"range": [9,10], "values": [1,10], "transactions": 100}

# False - financial, True - ratings
simulate(good_agent,bad_agent, datetime.date(2018, 10, 1), days, False)
reputation, avg_reputation = calculate_reputations(default_rep,conservativity,multiplier)
